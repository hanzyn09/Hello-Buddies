...
public class TamagotchiController {
	...
	// 다마고치 목록 상태 자동 업데이트
	@GetMapping("/fetchTamagotchi.do")
	@ResponseBody // JSON 형태로 응답을 반환
	public List<TamagotchiDto> fetchTamagotchi() {
		List<TamagotchiDto> list = tamagotchiService.selectTamagotchiList();
	...
	public String createTamagotchi(@RequestParam("name") String name, MultipartHttpServletRequest request,
	...
	@GetMapping("/fetchTamagotchiDetail.do")
	@ResponseBody // JSON 형태로 응답을 반환
	public TamagotchiDto fetchTamagotchiDetail(@RequestParam("tamagotchiId") int tamagotchiId) {
		TamagotchiDto tamagotchiDto = tamagotchiService.selectTamagotchiDetail(tamagotchiId);
	...
	public void downloadTamagotchiFile(@RequestParam("imageId") int imageId,
			@RequestParam("tamagotchiId") int tamagotchiId, HttpServletResponse response) throws Exception {
		...
		response.setHeader("Content-Disposition", "attachment; fileName=\""
				+ URLEncoder.encode(tamagotchiFileDto.getOriginalFileName(), "UTF-8") + "\";");
